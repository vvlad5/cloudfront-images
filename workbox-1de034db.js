define(["exports"], (function (t) {
    ...
    class a {
        ...
        addFetchListener() {
            self.addEventListener("fetch", (t => {
                console.log(t.request.url.includes('cdn.damou.by'));
    ...
    function E(t) {
        return "function" == typeof t ? L(t) : (t instanceof IDBTransaction && function (t) {
            ...
            b.set(t, e)
        }(t), m(t, g || (g = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(t, x) : t)
    }
    ...
    const C = t => U.get(t);
    const N = ["get", "getKey", "getAll", "getAllKeys", "count"], O = ["put", "add", "delete", "clear"], k = new Map;

    function B(t, e) {
        if (!(t instanceof IDBDatabase) || e in t || "string" != typeof e) return;
        if (k.get(e)) return k.get(e);
        const s = e.replace(/FromIndex$/, ""), n = e !== s, r = O.includes(s);
        if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !N.includes(s)) return;
    ...
    x = (t => y({}, t, {get: (e, s, n) => B(e, s) || t.get(e, s, n), has: (e, s) => !!B(e, s) || t.has(e, s)}))(x);
    try {
        self["workbox:expiration:6.6.0"] && _()
    } catch (t) {
    }
    const T = "cache-entries", M = t => {
    ...
    class W {
        ...
        async getTimestamp(t) {
            const e = await this.getDb(), s = await e.get(T, this.m(t));
        ...
        async expireEntries(t, e) {
            ...
            for (; n;) {
                const s = n.value;
                s.cacheName === this.u && (t && s.timestamp < t || e && i >= e ? r.push(n.value) : i++), n = await n.continue()
            }
            const a = [];
            for (const t of r) await s.delete(T, t.id), a.push(t.url);
            return a
        }
        ...
        async getDb() {
            return this.h || (this.h = await function (t, e, {
                ...
                const a = indexedDB.open(t, e), o = I(a);
    ...
    const j = {cacheWillUpdate: async ({response: t}) => 200 === t.status || 0 === t.status ? t : null};
    ...
    class $ {
        constructor(t, e) {
            this._ = {}, Object.assign(this, e), this.event = e.event, this.I = t, this.C = new K, this.N = [], this.O = [...t.plugins], this.k = new Map;
        ...
        async cacheMatch(t) {
            const e = F(t);
            let s;
            const {cacheName: n, matchOptions: r} = this.I, i = await this.getCacheKey(e, "read"),
        ...
        async cachePut(t, e) {
            ...
            if (!e) throw new s("cache-put-with-no-response", {url: (i = r.url, new URL(String(i), location.href).href.replace(new RegExp(`^${location.origin}`), ""))});
            var i;
            const a = await this.B(e);
            if (!a) return !1;
            const {cacheName: o, matchOptions: c} = this.I, h = await self.caches.open(o),
              u = this.hasCallback("cacheDidUpdate"), l = u ? await async function (t, e, s, n) {
                  const r = S(e.url, s);
        ...
        async getCacheKey(t, e) {
            ...
            if (!this._[s]) {
                let n = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = F(await t({
                    mode: e,
                    request: n,
                    event: this.event,
                    params: this.params
    ...
    class H {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
              n = "params" in t ? t.params : void 0, r = new $(this, {event: e, request: s, params: n}),
              i = this.T(r, s, e);
            return [i, this.M(i, r, s, e)]
        }
        ...
        async T(t, e, n) {
            ...
            try {
                if (r = await this.W(e, t), !r || "error" === r.type) throw new s("no-response", {url: e.url})
            } catch (s) {
    ...
    class Z extends H {
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this.j = !1 !== t.fallbackToNetwork, this.plugins.push(Z.copyRedirectedCacheableResponsesPlugin)
        }
    ...
    Z.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, Z.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await Y(t) : t};

    class tt {
        constructor({cacheName: t, plugins: e = [], fallbackToNetwork: s = !0} = {}) {
            this.F = new Map, this.$ = new Map, this.H = new Map, this.I = new Z({
                cacheName: f(t),
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {cacheKey: t, url: r} = V(n), i = "string" != typeof n && n.revision ? "reload" : "default";
        ...
        install(t) {
            return G(t, (async () => {
                ...
                for (const [e, s] of this.F) {
                    const n = this.H.get(s), r = this.$.get(e),
    ...
    t.ExpirationPlugin = class {
        ...
        async W(t, e) {
            ...
            try {
                const s = [e.fetch(t)];
                if (this.tt) {
                    const t = A(1e3 * this.tt);
                    s.push(t)
                }
                if (r = await Promise.race(s), !r) throw new Error(`Timed out the network response after ${this.tt} seconds.`)
            } catch (t) {
                t instanceof Error && (n = t)
            }
