...
define(["./workbox-1de034db"], (function (e) {
    ...
    })), e.clientsClaim(), e.precache([], {ignoreURLParametersMatching: [/.*/]}), e.cleanupOutdatedCaches(), e.registerRoute(/\.(?:jpg|jpeg|gif|png|svg|ico|webp)$/i, new e.StaleWhileRevalidate({
